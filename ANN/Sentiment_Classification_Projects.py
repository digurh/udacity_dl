...
class SentimentNetwork:
    ...
    def update_input_layer(self,review):
        ...
        # TODO: count how many times each word is used in the given review and store the results in layer_0
        for word in review.split(' '):
            # this line checks to see if word exists as a key
    ...
    def train(self, training_reviews, training_labels):
        ...
        for i in range(len(training_reviews)):
            ...
            # this updates self.layer_0 with the data retrieved from review
            # it is necessary, because self.update_input_layer will convert the strings unto usable numerical data
            ...
            output = self.sigmoid(hidden_layer.dot(self.weights_1_2))
            ...
            # weight updates: can do in one step, because weights belong to class
            self.weights_1_2 -= self.learning_rate*hidden_layer.T.dot(output_error_term)
            self.weights_0_1 -= self.learning_rate*self.layer_0.T.dot(hidden_error_term)
            
            # TODO: Keep track of correct predictions. To determine if the prediction wasself.
...
class SentimentNetwork:
    ...
    def run(self, review):
        ...
        for word in review.split(' '):
            if word in self.word2index.keys():
                run_reviews.append(self.word2index[word])
            
        for index in run_reviews:
            self.layer_1 += self.weights_0_1[index]
