...
train_words = [word for word in int_words if d_prob(threshold, freq_count[word]/total_words) < random.random()]# The final subsampled word list
...
def get_target(words, idx, window_size=5):
    ...
    # wrapping set automatically removes duplicates
    return list(set(words[start:end+1]))
